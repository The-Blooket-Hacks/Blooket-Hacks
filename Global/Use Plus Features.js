...
Object.values(document.querySelector('#app2 > div > div'))[1].children[1]._owner.stateNode.plus = true
Object.values(document.querySelector('#app2 > div > div'))[1].children[1]._owner.stateNode.state.user.hasPlus = true
Object.values(document.querySelector('#app2 > div > div'))[1].children[1]._owner.stateNode.forceUpdate()
}
