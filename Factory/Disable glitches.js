...
if (console_msg("Disable Glitches")) {
function stopGlitch() {
Object.values(document.querySelector("#app2 > div > div"))[1].children[0]._owner.stateNode.state.joke = false
Object.values(document.querySelector("#app2 > div > div"))[1].children[0]._owner.stateNode.state.dance = false
Object.values(document.querySelector("#app2 > div > div"))[1].children[0]._owner.stateNode.state.lol = false
}
