...
a.remove();
var level = prompt("What level?")
Object.values(document.querySelector('#app > div > div'))[1].children[0]._owner.stateNode.setState({ "level":Number(level)})
}
