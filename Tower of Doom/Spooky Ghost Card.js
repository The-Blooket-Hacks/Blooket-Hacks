...
if (console_msg("Spooky Ghost Card")) {
window.setInterval(function(){
    Object.values(document.querySelector('#app > div > div'))[1].children[0]._owner.stateNode.state.myCard = { blook: "Spooky Ghost", charisma: 500, class: "🪦", strength: 500, wisdom: 500}
})
}
